...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference('Bet.count') do
      post bets_url, params: { bet: { description: @bet.description, event: @bet.event, event_type: @bet.event_type, gain: @bet.gain, user_id: @bet.user_id, value: @bet.value } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { description: @bet.description, event: @bet.event, event_type: @bet.event_type, gain: @bet.gain, user_id: @bet.user_id, value: @bet.value } }
